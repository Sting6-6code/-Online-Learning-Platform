...
public class Assignment
{
  ...
  public Assignment(String aId, String aTitle, Date aDeadline, int aMaxScore, Course aCourse)
  {
    id = aId;
    title = aTitle;
    deadline = aDeadline;
  ...
  public boolean setCourse(Course aCourse)
  {
    ...
    if (course != null && course.numberOfCourseAssignments() <= Course.minimumNumberOfCourseAssignments())
    {
      return wasSet;
    }
